Sketch 2015-10-11a
--
This subfolder of the [sketches-2015-10 repo](https://github.com/dailysketches/sketches-2015-10) is the root of an individual openFrameworks sketch. It contains the full source code used to generate this sketch:

![Sketch 2015-10-11a](https://github.com/dailysketches/sketches-2015-10/blob/master/2015-10-11a/bin/data/out/2015-10-11a.png?raw=true)
[Listen to the sketch on Daily Sketches](http://dailysketches.github.io/sketch-11-10-2015/)"


This source code is published automatically along with each sketch I add to [Daily Sketches](http://dailysketches.github.io). Here is a [permalink to this sketch](http://dailysketches.github.io/sketch-11-10-2015/) on the Daily Sketches site.
